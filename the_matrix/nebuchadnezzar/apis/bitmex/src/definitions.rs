...
pub struct Execution {
    ...
    pub underlying_last_px: Option<Decimal>,
    ...
    pub simple_cum_qty: Option<Decimal>,
    #[serde(rename = "cumQty")]
...
pub struct Instrument {
    ...
    pub option_strike_pcnt: Option<Decimal>,
    #[serde(rename = "optionStrikeRound")]
    pub option_strike_round: Option<Decimal>,
    #[serde(rename = "optionStrikePrice")]
    pub option_strike_price: Option<Decimal>,
    #[serde(rename = "optionMultiplier")]
    pub option_multiplier: Option<Decimal>,
    ...
    pub init_margin: Option<Decimal>,
    ...
    pub limit_down_price: Option<Decimal>,
    #[serde(rename = "limitUpPrice")]
    pub limit_up_price: Option<Decimal>,
    #[serde(rename = "bankruptLimitDownPrice")]
    pub bankrupt_limit_down_price: Option<Decimal>,
    #[serde(rename = "bankruptLimitUpPrice")]
    pub bankrupt_limit_up_price: Option<Decimal>,
    ...
    pub home_notional24h: Option<Decimal>,
    #[serde(rename = "foreignNotional24h")]
    pub foreign_notional24h: Option<Decimal>,
    ...
    pub last_change_pcnt: Option<Decimal>,
    ...
    pub impact_bid_price: Option<Decimal>,
    #[serde(rename = "impactMidPrice")]
    pub impact_mid_price: Option<Decimal>,
    #[serde(rename = "impactAskPrice")]
    pub impact_ask_price: Option<Decimal>,
    ...
    pub fair_basis_rate: Option<Decimal>,
    #[serde(rename = "fairBasis")]
    pub fair_basis: Option<Decimal>,
    ...
    pub indicative_tax_rate: Option<Decimal>,
    #[serde(rename = "indicativeSettlePrice")]
    pub indicative_settle_price: Option<Decimal>,
    #[serde(rename = "optionUnderlyingPrice")]
    pub option_underlying_price: Option<Decimal>,
    #[serde(rename = "settledPrice")]
    pub settled_price: Option<Decimal>,
    pub timestamp: Option<DateTime<Utc>>,
}
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
...
pub struct Position {
    ...
    pub deleverage_percentile: Option<Decimal>,
    ...
    pub unrealised_pnl_pcnt: Option<Decimal>,
    #[serde(rename = "unrealisedRoePcnt")]
    pub unrealised_roe_pcnt: Option<Decimal>,
    #[serde(rename = "simpleQty")]
    pub simple_qty: Option<Decimal>,
    #[serde(rename = "simpleCost")]
    pub simple_cost: Option<Decimal>,
    #[serde(rename = "simpleValue")]
    pub simple_value: Option<Decimal>,
    #[serde(rename = "simplePnl")]
    pub simple_pnl: Option<Decimal>,
    #[serde(rename = "simplePnlPcnt")]
    pub simple_pnl_pcnt: Option<Decimal>,
    #[serde(rename = "avgCostPrice")]
    pub avg_cost_price: Option<Decimal>,
    ...
    pub margin_call_price: Option<Decimal>,
    #[serde(rename = "liquidationPrice")]
    pub liquidation_price: Option<Decimal>,
    #[serde(rename = "bankruptPrice")]
    pub bankrupt_price: Option<Decimal>,
    pub timestamp: Option<DateTime<Utc>>,
    #[serde(rename = "lastPrice")]
    pub last_price: Option<Decimal>,
...
#[into(nebuchadnezzar_core::definitions::Trade, skipping)]
pub struct Trade {
    #[into(include)]
    pub timestamp: DateTime<Utc>,
    pub symbol: String,
    pub side: Option<Side>,
    #[serde(rename = "size")]
    #[into(with = "self.amount.unwrap().into()")]
    pub amount: Option<i64>,
    #[into(with = "self.price.unwrap()")]
    pub price: Option<Decimal>,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[into(nebuchadnezzar_core::definitions::Candle, skipping)]
pub struct TradeBin {
    #[into(include)]
    pub timestamp: DateTime<Utc>,
    pub symbol: String,
    #[into(with = "self.open.unwrap()")]
    pub open: Option<Decimal>,
    #[into(with = "self.high.unwrap()")]
    pub high: Option<Decimal>,
    #[into(with = "self.low.unwrap()")]
    pub low: Option<Decimal>,
    #[into(with = "self.close.unwrap()")]
    pub close: Option<Decimal>,
    pub trades: Option<i64>,
    #[into(with = "self.volume.unwrap().into()")]
    pub volume: Option<i64>,
    pub vwap: Option<Decimal>,
...
pub struct AccessToken {
    ...
    pub ttl: Option<Decimal>,
    pub created: Option<DateTime<Utc>>,
    #[serde(rename = "userId")]
    pub user_id: Option<Decimal>,
}
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
...
pub struct QuoteFillRatio {
    ...
    pub quote_count: Option<Decimal>,
    #[serde(rename = "dealtCount")]
    pub dealt_count: Option<Decimal>,
    #[serde(rename = "quotesMavg7")]
    pub quotes_mavg7: Option<Decimal>,
    #[serde(rename = "dealtMavg7")]
    pub dealt_mavg7: Option<Decimal>,
    #[serde(rename = "quoteFillRatioMavg7")]
    pub quote_fill_ratio_mavg7: Option<Decimal>,
}
#[derive(Clone, Debug, Deserialize, Serialize)]
/// Account Operations
pub struct User {
...
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
pub struct UserCommissionsBySymbol(Value);
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct Margin {
    pub account: i64,
    pub currency: String,
    ...
    pub margin_balance_pcnt: Option<Decimal>,
    #[serde(rename = "marginLeverage")]
    pub margin_leverage: Option<Decimal>,
    #[serde(rename = "marginUsedPcnt")]
    pub margin_used_pcnt: Option<Decimal>,
    #[serde(rename = "excessMargin")]
    pub excess_margin: Option<i64>,
    #[serde(rename = "excessMarginPcnt")]
    pub excess_margin_pcnt: Option<Decimal>,
...
pub struct UserEvent {
    ...
    pub created_by_id: Option<Decimal>,
...
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
pub struct EventMetaEventMeta(Value);
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
pub struct UserPreferences {
    ...
    pub chat_channel_id: Option<Decimal>,
...
#[derive(Clone, Debug, Deserialize, Serialize, Default)]
pub struct OrderBookBinningOrderBookBinning(Value);
...
pub struct ExecutionHistory {
    ...
    #[serde(rename = "execComm")]
    pub exec_comm: Decimal,
    #[serde(rename = "execCost")]
    pub exec_cost: Decimal,
    #[serde(rename = "execGrossPnl")]
    pub exec_gross_pnl: Decimal,
    #[serde(rename = "execID")]
    pub exec_id: String,
    #[serde(rename = "execType")]
